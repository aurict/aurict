...
export const AGENT_TYPE_TOOLS: Record<AgentType, string[]> = {
  ...
  explore:     ["read", "glob", "grep", "webfetch", "websearch", "symbols", "code_map", "scratchpad", "send_message", "env_inspect", "diff_view", "file_stat"],
  ...
  review:      ["read", "glob", "grep", "lsp", "symbols", "code_map", "verify", "send_message", "diff_view", "file_stat"],
  test:        ["read", "glob", "grep", "bash", "symbols", "verify", "send_message", "file_stat"],
  docs:        ["read", "write", "edit", "glob", "grep", "symbols", "code_map", "send_message", "file_stat"],
  performance: ["read", "glob", "grep", "bash", "symbols", "code_map", "send_message", "process_monitor", "file_stat"],
  analytics:   ["read", "glob", "grep", "webfetch", "symbols", "send_message", "file_stat"],
  security:    ["read", "glob", "grep", "bash", "lsp", "webfetch", "websearch", "symbols", "code_map", "scratchpad", "track_variable_taint", "security_recon", "security_scan", "security_verify", "security_attack_graph", "security_log_analyze", "security_threat_model", "security_report", "send_message", "file_stat"],
  security_operator: ["read", "glob", "grep", "webfetch", "websearch", "symbols", "code_map", "scratchpad", "security_recon", "security_scan", "security_verify", "security_attack_graph", "security_log_analyze", "security_threat_model", "security_report", "send_message", "file_stat"],
  ...
  debug:       ["read", "glob", "grep", "bash", "lsp", "symbols", "verify", "scratchpad", "send_message", "env_inspect", "checkpoint", "process_monitor", "file_stat"],
