...
const SKILL_SUGGESTIONS: Record<AgentType, string[]> = {
  ...
  security: ["security-review", "pentest-tooling", "authentication-patterns"],
  security_operator: ["security-review", "pentest-tooling", "pentest-recon"],
  security_verifier: ["security-review", "pentest-owasp", "authentication-patterns"],
  security_reporter: ["security-review", "documentation-patterns"],
  pentest:  ["pentest-tooling", "pentest-owasp", "pentest-recon"],
  adviser:  ["pentest-owasp", "pentest-protocols", "pentest-cloud"],
