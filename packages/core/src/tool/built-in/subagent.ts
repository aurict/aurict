...
- security_operator: security_recon, security_scan, security_report  (controlled assessment loop)
- security_verifier: read, webfetch, security_report  (evidence review + false-positive reduction)
- security_reporter: read, write, security_report  (validated security report generation)
