...
const copy = {
  en: {
    hero: {
      ...
      moreProviders: (count) => `+${count} more — bring your own key`, threadAria: "Aurict work thread", threadLabel: "aurict / work thread", liveContext: "live context", prompt: "Move this codebase forward safely.",
    ...
    sections: {
      ...
      desktopWorkspace: "desktop workspace", byAurict: "by Aurict", hoprelBody: "A local-first AI workspace for conversations, files, artifacts, Design Studio, Finance Desk, and remote control.", downloadHoprel: "download Hoprel",
    ...
    phone: { request: "Research AI support tools for solo founders and make a PDF brief.", answer: "I’ll compare pricing, workflows, and positioning.", scan: "research scan", running: "running", sourcesSummary: "12 sources · competitor notes · citations", cliSession: "CLI session", approval: "approval", approvalBody: "approve a terminal action from mobile", approve: "approve", deny: "deny" },
  ...
  tr: {
    hero: {
      ...
      moreProviders: (count) => `+${count} daha — kendi anahtarını getir`, threadAria: "Aurict çalışma akışı", threadLabel: "aurict / çalışma akışı", liveContext: "canlı bağlam", prompt: "Bu kod tabanında güvenle ilerle.",
    ...
    sections: {
      ...
      desktopWorkspace: "masaüstü çalışma alanı", byAurict: "Aurict tarafından", hoprelBody: "Sohbetler, dosyalar, çıktılar, Tasarım Stüdyosu, Finans Masası ve uzaktan kontrol için yerel öncelikli bir yapay zekâ çalışma alanı.", downloadHoprel: "Hoprel'i indir",
      nativeRuntime: "yerel çalışma zamanı", terminalBody: "Ajan tabanlı kodlama, çoklu ajan yürütmesi, MCP, yerel bağlam, sınırlı Project Auto ve açık onaylar için açık kaynak çalışma zamanı.", installShell: "açık kaynak terminal ajanını keşfet",
    ...
    phone: { request: "Solo girişimciler için AI destek araçlarını araştır ve PDF özeti hazırla.", answer: "Fiyatlandırma, iş akışları ve konumlandırmayı karşılaştıracağım.", scan: "araştırma taraması", running: "çalışıyor", sourcesSummary: "12 kaynak · rakip notları · alıntılar", cliSession: "CLI oturumu", approval: "onay", approvalBody: "terminal eylemini mobilden onayla", approve: "onayla", deny: "reddet" },
  ...
  de: {
    hero: {
      ...
      moreProviders: (count) => `+${count} weitere — eigener API-Schlüssel`, threadAria: "Aurict-Arbeitsablauf", threadLabel: "aurict / Arbeitsablauf", liveContext: "Live-Kontext", prompt: "Entwickle diese Codebasis sicher weiter.",
    ...
    sections: {
      ...
      desktopWorkspace: "Desktop-Arbeitsbereich", byAurict: "von Aurict", hoprelBody: "Ein lokaler KI-Arbeitsbereich für Gespräche, Dateien, Artefakte, Design, Finanzen und Fernsteuerung.", downloadHoprel: "Hoprel herunterladen",
      nativeRuntime: "native Laufzeit", terminalBody: "Die Open-Source-Laufzeit für agentenbasiertes Coding, Multi-Agent-Ausführung, MCP, lokalen Kontext und explizite Freigaben.", installShell: "Open-Source-Terminal-Agent entdecken",
    ...
    phone: { request: "Recherchiere KI-Supporttools für Solo-Gründer und erstelle ein PDF-Briefing.", answer: "Ich vergleiche Preise, Abläufe und Positionierung.", scan: "Recherche", running: "läuft", sourcesSummary: "12 Quellen · Wettbewerbsnotizen · Belege", cliSession: "CLI-Sitzung", approval: "Freigabe", approvalBody: "Terminalaktion mobil freigeben", approve: "freigeben", deny: "ablehnen" },
  ...
  fr: {
    hero: {
      ...
      moreProviders: (count) => `+${count} autres — utilisez votre propre clé`, threadAria: "Flux de travail Aurict", threadLabel: "aurict / flux de travail", liveContext: "contexte actif", prompt: "Fais progresser ce code en toute sécurité.",
    ...
    sections: {
      ...
      desktopWorkspace: "espace de bureau", byAurict: "par Aurict", hoprelBody: "Un espace IA local-first pour les conversations, fichiers, livrables, le design, la finance et le contrôle à distance.", downloadHoprel: "télécharger Hoprel",
      nativeRuntime: "runtime natif", terminalBody: "Le runtime open source pour le code agentique, l’exécution multi-agent, MCP, le contexte local et les autorisations explicites.", installShell: "découvrir l’agent de terminal open source",
    ...
    phone: { request: "Recherche les outils de support IA pour indépendants et crée un résumé PDF.", answer: "Je vais comparer les prix, les workflows et le positionnement.", scan: "recherche", running: "en cours", sourcesSummary: "12 sources · notes sur les concurrents · citations", cliSession: "session CLI", approval: "autorisation", approvalBody: "approuver une action du terminal sur mobile", approve: "approuver", deny: "refuser" },
  ...
  es: {
    hero: {
      ...
      moreProviders: (count) => `+${count} más — usa tu propia clave`, threadAria: "Flujo de trabajo de Aurict", threadLabel: "aurict / flujo de trabajo", liveContext: "contexto activo", prompt: "Haz avanzar este código de forma segura.",
    ...
    sections: {
      ...
      desktopWorkspace: "espacio de escritorio", byAurict: "de Aurict", hoprelBody: "Un espacio de IA local-first para conversaciones, archivos, entregables, diseño, finanzas y control remoto.", downloadHoprel: "descargar Hoprel",
      nativeRuntime: "runtime nativo", terminalBody: "El runtime de código abierto para programación con agentes, ejecución multiagente, MCP, contexto local y aprobaciones explícitas.", installShell: "explorar el agente de terminal de código abierto",
    ...
    phone: { request: "Investiga herramientas de soporte con IA para fundadores y prepara un resumen en PDF.", answer: "Compararé precios, flujos de trabajo y posicionamiento.", scan: "investigación", running: "en curso", sourcesSummary: "12 fuentes · notas de competidores · citas", cliSession: "sesión de CLI", approval: "aprobación", approvalBody: "aprobar una acción de terminal desde el móvil", approve: "aprobar", deny: "rechazar" },
